...
- Fonts via next/font/google:
  ...
  - UI: Inter
- Optional: framer-motion ONLY for subtle transitions; respect prefers-reduced-motion.

STYLE (must match premium dark/glass inspiration, gaming premium)
...
--surface: rgba(255,255,255,0.06); --surface-2: rgba(255,255,255,0.09);
--border: rgba(255,255,255,0.10);
--text-1: rgba(255,255,255,0.92); --text-2: rgba(255,255,255,0.72); --text-3: rgba(255,255,255,0.52);
--gold: #f5c451; --gold-2: #d9a62d;
...
- Also add docs:
  - layout.md, typography.md, components.md, content.md, routes.md
    (create them in the repo root or /docs)
...
- [ ] Filters: type/chain/status/dev/tags work together
